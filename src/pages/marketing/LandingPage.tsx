          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">scopoStay</span>
              </Link>
            ...
            >
              <motion.div variants={itemVariants} className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-16 text-center md:text-right">
                  <h3 className="text-xl font-bold text-gray-900">Create custom templates</h3>
                  <p className="mt-2 text-gray-600">
                    Build reusable inspection templates for different room types with our intuitive form builder.
                  </p>
                </div>
                <div className="mt-6 md:mt-0 flex justify-center w-full md:w-16">
                  <div className="bg-primary-500 text-white rounded-full h-12 w-12 flex items-center justify-center shadow-lg z-10">
                    <span className="font-bold">1</span>
                  </div>
                </div>
                <div className="mt-6 md:mt-0 md:w-1/2 md:pl-16 text-center md:text-left">
                  <img 
                    src="https://images.pexels.com/photos/5882697/pexels-photo-5882697.jpeg?auto=compress&cs=tinysrgb&w=500" 
              ...
              <motion.div variants={itemVariants} className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-16 text-center md:text-right order-2 md:order-1">
                  <img 
                    src="https://images.pexels.com/photos/7148384/pexels-photo-7148384.jpeg?auto=compress&cs=tinysrgb&w=500" 
                    alt="Property inspection" 
                    className="h-48 w-full object-cover rounded-lg shadow-md" 
                  />
                </div>
                <div className="mt-6 md:mt-0 flex justify-center w-full md:w-16 order-1 md:order-2">
                  <div className="bg-primary-500 text-white rounded-full h-12 w-12 flex items-center justify-center shadow-lg z-10">
                    <span className="font-bold">2</span>
                  </div>
                </div>
                <div className="mt-6 md:mt-0 md:w-1/2 md:pl-16 text-center md:text-left order-3">
                  <h3 className="text-xl font-bold text-gray-900">Conduct inspections</h3>
                  <p className="mt-2 text-gray-600">
                    Use your phone camera to document property conditions during check-ins and check-outs.
                  </p>
                </div>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-16 text-center md:text-right">
                  <h3 className="text-xl font-bold text-gray-900">AI damage detection</h3>
                  <p className="mt-2 text-gray-600">
                    Our AI automatically identifies potential damages, saving you time and ensuring nothing is missed.
                  </p>
                </div>
                <div className="mt-6 md:mt-0 flex justify-center w-full md:w-16">
                  <div className="bg-primary-500 text-white rounded-full h-12 w-12 flex items-center justify-center shadow-lg z-10">
                ...
                <div className="mt-6 md:mt-0 md:w-1/2 md:pl-16 text-center md:text-left">
                  <img 
                    src="https://images.pexels.com/photos/3913025/pexels-photo-3913025.jpeg?auto=compress&cs=tinysrgb&w=500" 
                    alt="AI detection" 
                    className="h-48 w-full object-cover rounded-lg shadow-md" 
                  />
                </div>
              ...
              <motion.div variants={itemVariants} className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-16 text-center md:text-right order-2 md:order-1">
                  <img 
                    src="https://images.pexels.com/photos/6693661/pexels-photo-6693661.jpeg?auto=compress&cs=tinysrgb&w=500" 
                    alt="PDF report" 
                    className="h-48 w-full object-cover rounded-lg shadow-md" 
                  />
                </div>
                ...
                <div className="mt-6 md:mt-0 md:w-1/2 md:pl-16 text-center md:text-left order-3">
                  <h3 className="text-xl font-bold text-gray-900">Generate professional reports</h3>
                  <p className="mt-2 text-gray-600">
                    Create branded, detailed PDF reports documenting property conditions and any identified issues.
                  </p>
                </div>
              </motion.div>
            </motion.div>
